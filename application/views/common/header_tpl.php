...
<header class="header white-bg">
                ...
                <ul class="nav top-menu">
                    ...
                    <!-- <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/avatar-mini.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/avatar-mini2.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?=base_url()?>assets/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
            ...
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="<?=base_url()?>assets_front/img/ashana-Logo-1.png" style="width:20px;">
                            <span class="username"><?php echo $session_name ?></span>
                            <b class="caret"></b>
                        </a>
